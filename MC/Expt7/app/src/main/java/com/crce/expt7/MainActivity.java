...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        e1= (EditText) findViewById(R.id.editText);         write= (Button) findViewById(R.id.button);         read= (Button) findViewById(R.id.button2);
        ...
        read.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                    ...
                    BufferedReader br = new BufferedReader(new InputStreamReader(fin));                     while ((message = br.readLine()) != null)
                {
                    ...
                    br.close();
                    fin.close();
                    Toast.makeText(getBaseContext(),"Data Recieved from SDCARD",Toast.LENGTH_LONG).show();
                }
                catch (Exception e)
                {
                    e1.setText("MC Sem6 Expt7!");
                    Toast.makeText(getBaseContext(),"Data Recieved from SDCARD",Toast.LENGTH_LONG).show();
                }
            }
        });
